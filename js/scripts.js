...
(function($) {
    ...
    document.getElementById("myButton").addEventListener("click",function() {
        window.location.href = "https://docs.google.com/forms/d/1UN23_74RkbU9vBV87FCsRH1JKx1HuSVG62ZFRlWZXxw/edit";
    });

    document.getElementById("Rule book").addEventListener("click",function() {
        window.location.href = "https://drive.google.com/file/d/1y2P5doFUvmRmO9f9f0uP8apXdUWczNIS/view?usp=share_link";
    });

    document.getElementById("youtube").addEventListener("click",function() {
        window.location.href = "https://www.youtube.com/watch?v=qvNuUyoe9Ts";
    });

    document.getElementById("Instagram").addEventListener("click",function() {
        window.location.href = "https://www.instagram.com/rivals_2k23_/";
    });
